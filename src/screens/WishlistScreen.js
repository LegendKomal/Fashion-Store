...
const styles = StyleSheet.create({
  ...
  empty: {
    ...
    alignItems: 'center', backgroundColor: '#f8f8ff', gap: 8,
  },
  emptyText: { fontSize: 20, fontWeight: '700', color: '#0f172a', marginTop: 12 },
  emptySubText: { fontSize: 14, color: '#94a3b8' },
  shopBtn: {
    marginTop: 16, backgroundColor: '#6366f1',
  ...
  category: { fontSize: 11, color: '#94a3b8', marginBottom: 4, textTransform: 'capitalize' },
  price: { fontSize: 16, fontWeight: '800', color: '#6366f1', marginBottom: 10 },
